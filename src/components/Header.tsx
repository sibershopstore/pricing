        ...
        {isOpen && (
          <div className="md:hidden pt-2 pb-4">
            <ul className="space-y-2">
              ...
              <li><Link to="/#pricing" className="block py-2 hover:text-blue-400 transition-colors" onClick={() => setIsOpen(false)}>Pricing</Link></li>
              <li><Link to="/#faq" className="block py-2 hover:text-blue-400 transition-colors" onClick={() => setIsOpen(false)}>FAQ</Link></li>
